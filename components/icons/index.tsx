...
/** Dashboard — Dashboard Grid Icon (uxwing.com/dashboard-icon/) */
...
/** Flask — Lab Flask Icon (uxwing.com/laboratory-flask-icon/) */
export function IcFlask(props: UxwIconProps) {
  return (
    <UxwIcon viewBox="0 0 24 24" {...props}>
      <path d="M7 2v2h1v5.59l-4.7 7.05A2 2 0 0 0 5.12 20h13.76a2 2 0 0 0 1.82-3.36L16 9.59V4h1V2H7zm3 2h4v6.17l3.53 5.3a.5.5 0 0 1-.41.53H6.88a.5.5 0 0 1-.41-.53L10 10.17V4z" />
    </UxwIcon>
  );
}
...
/** Calendar — Calendar Date Icon (uxwing.com/calendar-date-icon/) */
export function IcCalendar(props: UxwIconProps) {
  return (
    <UxwIcon viewBox="0 0 24 24" {...props}>
